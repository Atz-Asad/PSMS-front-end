...
<head>
	...
	<!-- DESCRIPTION -->
	<meta name="description" content="PSMS - Student Deshbord" />
	
	<!-- OG -->
	<meta property="og:title" content="PSMS - Student Deshbord" />
	<meta property="og:description" content="PSMS - Student Deshbord" />
	...
	<!-- PAGE TITLE HERE ============================================= -->
	<title>PSMS - Student Deshbord</title>
			...
			<div class="ttr-logo-box">
				<div>
					<a href="index.php" class="ttr-logo">
						...
						<img class="ttr-logo-desktop" alt="" src="assets/images/logo-white-1.png" width="160" height="27">
					</a>
				</div>
			</div>
			<!--logo end -->
	...
	<div class="ttr-sidebar">
		<div class="ttr-sidebar-wrapper content-scroll">
			...
			<div class="ttr-sidebar-logo">
				<a href="index.php"><img alt="" src="assets/images/logo-1.png" width="122" height="27"></a>
