...
if(isset($_POST['st_submit'])){
	...
	$st_brithday = $_POST['st_brithday'];
	$st_address = $_POST['st_address'];
	$st_password = $_POST['st_password'];

	// count mobile or email
	$stcountMobile = stRowCount('mobile',$st_mobile);
	$stcountEmail = stRowCount('email',$st_email);
	...
	if(empty($st_name)){
		...
		if($insertStatus == true){
			$success = "Your Registration Sucessfully !";
		}
		else{
						...
						<div class="col-lg-12">
							<div class="form-group">
								<div class="input-group">
									...
									<input name="st_brithday" type="date"  class="form-control">
								</div>
							</div>
						</div>
						<div class="col-lg-12">
